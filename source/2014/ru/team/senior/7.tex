...
\begin{figure}\centering
    ...
    \caption{к решению задачи \ref{2014/ru/team/senior/7:solution}}
    \label{2014/ru/team/senior/7:solution:fig}
\end{figure}%
\fi}%
\endgroup % figure

\problem\problemscore{8}
% duplicate of [2014/ru/team/junior/9]
Для каких $n$ выпуклый $n$-угольник можно разрезать на~выпуклые шестиугольники?
\solution
\label{2014/ru/team/senior/7:solution}%
\emph{Ответ:} $n = 6$ и~$n \geq 8$.
\par
\ifsolutiondefined
См.~решение задачи \ref{2014/ru/team/junior/9:solution}.
\else
\definesolution
...
(рис.~\ref{2014/ru/team/senior/7:solution:fig}).
