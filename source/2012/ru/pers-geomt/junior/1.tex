...
\begin{figure}\centering
    ...
    \caption{к решению задачи \ref{2012/ru/pers-geomt/junior/1:solution}}
    \label{2012/ru/pers-geomt/junior/1:solution:fig}
\end{figure}%
\fi % \ifsolution
...
\solution
\label{2012/ru/pers-geomt/junior/1:solution}%
\emph{Ответ:}
$\angle A = \angle C = 60^\circ$,
$\angle B = \angle D = 120^\circ$.
\par
Рис.~\ref{2012/ru/pers-geomt/junior/1:solution:fig}.
