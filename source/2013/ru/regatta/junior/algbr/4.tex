...
\problem
% duplicated in [2013/ru/pers-algbr/senior/1]
...
\solution
\label{2013/ru/regatta/junior/algbr/4:solution}%
\emph{Ответ:} 19950.
\par
\ifsolutiondefined
См.~решение задачи \ref{2013/ru/pers-algbr/senior/1:solution}.
\else
\definesolution
\emph{Оценка.}
...
\begin{table}\centering
    \fbox{\(\begin{array}{ccccccc}
        ...
        1 & 2 \\
          ...
          &   &   &   &   & 1 & 198
    \end{array}\)}
    \caption{к решению задачи \ref{2013/ru/regatta/junior/algbr/4:solution}.}
    \label{table:2013/ru/regatta/junior/algbr/4:solution}
\end{table}%
Покажем, что существует пример, когда реализуются ровно такие суммы.
Для этого на главной диагонали расставим четные числа от нуля до $198$, на
второй диагонали единицы в клеточках через 1
(таблица \ref{table:2013/ru/regatta/junior/algbr/4:solution}).
